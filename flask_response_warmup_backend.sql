...
--
-- Host: localhost    Database: flask_response_warmup_backend
-- ------------------------------------------------------
...
/*!50003 DROP PROCEDURE IF EXISTS `get_all_pokemons` */;
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_pokemon`(
...
-- Dump completed on 2022-10-13 16:17:25
